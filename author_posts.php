...
<!--THIS IS FOR GETTING ALL THE POST FOR THE SAME AUTHOR ON ONE PAGE-->
...
<div class="name-author"><i class="icon-user icon-white"></i> <a href="author_posts.php?author=<?php echo $post_author;?>&p_id=<?php echo $post_id;?>"><?php echo $post_author;?></a></div>
